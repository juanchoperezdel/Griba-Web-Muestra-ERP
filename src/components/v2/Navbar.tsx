...
const NAV_LINKS = [
  ...
  { href: "#porque", label: "Por qué Griba" },
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {/* CTA siempre visible (también en mobile) para agendar sin abrir el menú */}
          <a
            href="#calendario"
            className="inline-flex bg-fg hover:bg-brand-600 text-white px-4 py-2 md:px-5 md:py-2.5 rounded-full text-sm font-semibold transition-colors shadow-sm whitespace-nowrap"
          >
            Agendar demo
          </a>
