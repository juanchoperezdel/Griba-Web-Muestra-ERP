...
const STEPS = [
  {
    ...
    desc: "Qué sistema usás hoy, cuánta gente trabaja con él y dónde se traba el día a día.",
    duration: "10 min",
  },
  {
    n: 2,
    title: "Demo con datos parecidos a los tuyos",
    desc: "No una presentación enlatada: te mostramos Griba sobre tu tipo de operación —ventas, stock, cuenta corriente, facturación.",
    duration: "15 min",
  },
  {
    n: 3,
    title: "Próximos pasos y rango de inversión",
    desc: "Si avanzamos, te damos un plan de migración con plazos y un rango claro.",
    duration: "5 min",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            >
              ...
              <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-6 leading-tight text-fg">
                ...
                <br />
                <span className="text-brand-600">Solo qué no te está funcionando.</span>
              </h2>
              <p className="text-lg text-fg-muted mb-10 max-w-lg leading-relaxed">
                30 minutos. Te mostramos dónde estás perdiendo control hoy —ventas, stock, cobranzas,
                facturación— con datos parecidos a los tuyos. Sin PowerPoint genérico.
              </p>
            ...
            >
              <iframe
                ...
                style={{
                  width: "100%",
                  // Altura mínima para que el calendario se vea completo aunque el
                  // autoresize de LeadConnector tarde o no dispare (SPA / mobile).
                  // El script lo agranda si el contenido necesita más.
                  minHeight: "720px",
                  border: "none",
                  overflow: "hidden",
                  borderRadius: "12px",
